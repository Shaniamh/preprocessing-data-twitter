...
if __name__ == '__main__':
    #==========Baca file csv===================
    df = pd.read_csv('_RainbowKandy_tweets.csv', encoding='latin-1')
    #PRINT DATA
    print(df)
    ...
    for f in range(df.shape[0]):
        ...
        ascii = unicodetoascii(fiveprocess)
...
#====CREATE FILE CSV=====================
   # print("BERHASIL MENYIMPAN FILE CSV")
    #df.to_csv(r'E:\1 DATA KULIAH\D4 IT B SEMESTER 7\TUGAS AKHIR\DATA PROCESSING SHANIA\USER\Alice_Vogue.csv', index = None, header=True)